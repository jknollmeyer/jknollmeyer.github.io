...
var BodyContent = React.createClass({displayName: "BodyContent",
  render: function(){
    if(this.props.status == "AboutMe")
      ...
      return (React.createElement(ProjectsContent, null));
    }
  }
});
...
var PageHTML = React.createClass({displayName: "PageHTML",
      ...
      React.createElement("div", null, 
        React.createElement("div", {id: "titleContent"}, 
          React.createElement("div", {className: "row", id: "menuBar"}, 
            React.createElement(MenuItem, {id: "Projects", status: route, onClick: projectsClick}), 
            React.createElement(MenuItem, {id: "AboutMe", status: route, onClick: aboutClick}), 
            React.createElement(MenuItem, {id: "Resume", status: route, onClick: resumeClick})
          )
        ), 
        React.createElement("div", {id: "bodyContent", style: this.state.bodyStyle}, 
          React.createElement(BodyContent, {status: route})
        )
      )
    );
  },
  menuClick: function(route, e){
    ...
    $("#bodyContent").fadeOut(function(){
      ...
      this.setState({status: route}); // currently using setstate to force a re-render
      $("#bodyContent").fadeIn();
    }.bind(this));
...
},{"./js/about_content.jsx":2,"./js/contact_content.jsx":3,"./js/projects_content.jsx":4,"./js/resume_content.jsx":5,"react":163,"react-dom":34}],2:[function(require,module,exports){
var React = require('react');
